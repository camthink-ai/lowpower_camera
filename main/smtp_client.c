...
#define MAIL_SERVER         "smtp.163.com"
#define MAIL_PORT           "465"
#define SENDER_MAIL         "zbing1632023@163.com"
#define SENDER_PASSWORD     "CEGIJHXYJMHTHVHZ"
#define RECIPIENT_MAIL      "zbing@milesight.com"
